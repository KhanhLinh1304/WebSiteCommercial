								...
								<div id="wrapper">
									<div class="slider-wrapper">
										<div id="mainSlider" class="nivoSlider">
											<img src="<c:url value='/template/web/img/slider/homepage2/3.jpg'/>" alt="main slider" title="#htmlcaption"/>
											<img src="<c:url value='/template/web/img/slider/homepage2/4.jpg'/>" alt="main slider" title="#htmlcaption2"/>
										</div>
