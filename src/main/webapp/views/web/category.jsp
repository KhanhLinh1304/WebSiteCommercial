                    ...
                    <div class="product-single-sidebar">
                        ...
                        <form action="" class="size">
                            <ul>
                                <li>
                                    <label class="all">
                                        <input type="checkbox" name="all" class="checkbox" checked/>
                                        <span></span>
                                    </label>
                                    <a href="#">Tất cả</a>
                                </li>
...
<script>
    let getUrlParameter = function getIdCategory(param) {
        let pageUrl = window.location.search.substring(1),
            urlVariable = pageUrl.split('&'),
            name, i;
        for (let i = 0; i < urlVariable.length; i++) {
            name = urlVariable[i].split('=');
            if (name[0] === param) {
                return name[1]
            }
        }
    ...
    $('.all>input').click(function () {
        if ($('.all>input').prop('checked')) {
            $('.cheker>input').prop('checked', false);
        }
    });
    $('.checkbox').click(function () {
        if ($('.cheker>input').prop('checked')) {
            $('.all>input').prop('checked', false);
        } else {
            let allChecked = true;
            $('.cheker>input').each(function () {
