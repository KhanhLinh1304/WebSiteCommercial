...
<link rel="stylesheet"
	href="<c:url value='/template/login/fonts/icomoon/style.css'/>" />

<link rel="stylesheet"
	href="<c:url value ='/template/login/css/owl.carousel.min.css'/>" />

<!-- Bootstrap CSS -->
<link rel="stylesheet"
	href="<c:url value ='/template/login/css/bootstrap.min.css'/>" />
